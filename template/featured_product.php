            <section class="section">
              <div class="container">
                <h3 class="text-center" style="margin-bottom: 7vh;">FEATURED PRODUCTS</h3>
                ...
                <div class='row'>
                  ...
                  <?php  
                    ...
                    $query = "SELECT * FROM tbl_products WHERE product_featured = 1 ORDER BY product_id ASC LIMIT 2";
                    ...
                    <div class="col-md-6">
                      <div class='product--red'>
                        <div class='product_inner'>
                          ...
                          <p style="font-size: 20px;margin-top: 15px;"><?php echo $product_name; ?></p>
