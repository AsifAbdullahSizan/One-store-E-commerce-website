...
<body>
	<div class="filter filter-color-red">
		<!-- login -->
		<div class="container login-section signup-section">	
			<div class="login-w3l">	
				<div class="login-form">	
					...
					<form action="#" method="post" class="agile_form">
						<div class="w3ls-name1">
							...
							<input placeholder="fullname" type="text" required name="fullname">
						</div>
						<div class="w3ls-name1">
						...
						<div class="w3ls-name1">
							...
							<input placeholder="*****" type="password" required name="password1">
						</div>	
						<div class="w3ls-name1">
							<label class="header">RE-ENTER PASSWORD</label>	
							<input placeholder="*****" type="password" required name="password2">
						</div>	
						...
						<a href="index.php" style="width: 40%;
								    ...
								    float: left;
    ">Back To Home</a>
						<a href="signin.php" style="width: 50%;
								    margin: 1em auto 0;
								    cursor: pointer;
								    outline: none;
								    color: #fff;
    ...
    ">Already A Member?</a>
			...
			<div class="login-w3l-bg">	
				<div class="" style="width: 100%; background-color: red; text-align: center; padding: 33.1vh 10px; display: block; ">
...
<?php 
	include 'dashboard/function/signup_script.php';
?>
